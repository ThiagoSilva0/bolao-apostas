...
public class RelatorioRodada {
    ...
    */
    public void getRelatorio(List<Rodada> rodadas){
        stream = this.getClass().getResourceAsStream("/br.com.bolao.report/rodada.jasper");
        ...
        try {
            ...
            */
            JasperPrint print = JasperFillManager.fillReport(report, params, new JRBeanCollectionDataSource(rodadas));
